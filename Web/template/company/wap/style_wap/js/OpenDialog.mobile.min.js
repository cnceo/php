            ...
            try {
                ...
                if (href == "/" || href == "" || href.indexOf("?") == 0) {
                    if (typeof top._sys_admin_idcorp != "undefined") {
                        href = "/corpsvc/temp/t/mdefault.aspx?idcorp=" + top._sys_admin_idcorp + "&dname=yes&from2=editview&client=m&return=1";
                    }
                }
                else {//子页时
            ...
            '<div style="position:absolute;top:0px;left:0px;background-color:#dfdfdf;display:none;">'
                + '<div class="content" style="position:relative;height:70px;text-align:center;vertical-align:middle;">'
                    + '<div class="img" style="position:relative;float:left;width:20px;height:30px;">'
                        + '<img style="width:18px;height:18px;border:0px;position:relative;top:6px;left:0px;" src="http://www.quickapp.cn/app/gen/options/img/loading.gif"/>'
                    + '</div>'
...
OpenDialogFrame.prototype = {
    "Init": function () {
        ...
        var frameHtml = '<iframe scrolling="' + scrolling + '" frameborder="0" src="' + this._Top.getUri() + '" allowtransparency="true"></iframe>';

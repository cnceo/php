...
var pop_up_note_mode = true;
        ...
        function playbksound() {
            ...
            if (document.body.offsetWidth > 400) {
                bg_htm = "<img id='sound_image' src='../template/company/wap/style_home/img/music_note_big.png'>";
                box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-20px;top:-80px'></div>";
            }
            else {
                bg_htm = "<img id='sound_image' width='30px' src='../template/company/wap/style_home/img/img/music_note_big.png'>";

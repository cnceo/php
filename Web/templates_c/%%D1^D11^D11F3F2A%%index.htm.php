...
";</script>
	...
	<div class="fixed_left"><div class="rem_chlose_left">选择简历模板</div>
...
&<?php endif; ?>id=<?php echo $this->_tpl_vars['Info']['id']; ?>
&tmp=3">简约风格</a></div>
        <div class="resume_template  resume_template_bg" onClick="settemplate('3')">使用此模版</div>
    </div>
...
岁）</span><img src="<?php echo $this->_tpl_vars['config']['sy_weburl']; ?>
/template/default/resume/jianli3/images/sf.png" title="身份已认证"><em class="sf_yz"><?php if ($this->_tpl_vars['Info']['idcard_status'] == 1 && $this->_tpl_vars['Info']['idcard']): ?>已认证<?php endif; ?></em></div>
...
<!--求职意向-->
<div class="vita_list">
<div class="vita_Intention  vita_Intention_w420">工作地区：<span class="vita_Intention_em"><?php echo $this->_tpl_vars['Info']['city_one']; ?>
 <?php echo $this->_tpl_vars['Info']['city_two']; ?>
 <?php echo $this->_tpl_vars['Info']['city_three']; ?>
</span> </div>        
<div class="vita_Intention">期望行业：<span class="vita_Intention_em"><?php echo $this->_tpl_vars['Info']['hy']; ?>
 </span> </div>
<div class="vita_Intention vita_Intention_w420">待遇要求<span class="vita_Intention_em">：<?php echo $this->_tpl_vars['Info']['salary']; ?>
 <?php if ($this->_tpl_vars['Info']['salary'] != "面议"): ?> <font color="#888888">RMB</font><?php endif; ?></span>  </div>                             
<div class="vita_Intention ">到职时间：<span class="vita_Intention_em"><?php echo $this->_tpl_vars['Info']['report']; ?>
  </span> </div>
<div class="vita_Intention vita_Intention_w420">职位性质：<span class="vita_Intention_em"><?php echo $this->_tpl_vars['Info']['type']; ?>
   </span> </div>  
<div class="vita_Intention" style="width:100%">期望职位：<span class="vita_Intention_cor"><?php echo $this->_tpl_vars['Info']['jobname']; ?>
</span> </div>        
...
<!--自我评价-->
<div class="vita_list">
<div class="vita_list_h1"><span class="vita_list_h1_span">自我评价</span></div>
<div class="vita_skill">
<div class="vita_skill_Intention">自我评价：<?php echo $this->_tpl_vars['Info']['description']; ?>
 </div>        
</div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span ">工作经历</span></div>
...
<div class="vita_introduction_a vita_date">工作时间：<?php echo ((is_array($_tmp=$this->_tpl_vars['one']['sdate'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y年%m月") : smarty_modifier_date_format($_tmp, "%Y年%m月")); ?>
...
<div class="vita_introduction_a vita_date">工作部门：<?php echo $this->_tpl_vars['one']['department']; ?>
</div > 
<div class="vita_introduction_a vita_date">在职职位：<?php echo $this->_tpl_vars['one']['title']; ?>
</div > 

</div>
<div class="vita_skill_Intention">工作职责：<?php echo $this->_tpl_vars['one']['content']; ?>
 </div>       
</div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">教育经历</span></div>
...
<?php echo ((is_array($_tmp=$this->_tpl_vars['one']['sdate'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y年%m月") : smarty_modifier_date_format($_tmp, "%Y年%m月")); ?>
...
|
担任：<?php echo $this->_tpl_vars['one']['title']; ?>

</div>    
<div class="vita_skill_Intention">专业描述：<?php echo $this->_tpl_vars['one']['content']; ?>
</div>        
</div>
</div>
<?php endforeach; endif; unset($_from); ?>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">专业技能</span></div>
...
<div class="vita_introduction_a vita_dw_bm">技能名称：<?php echo $this->_tpl_vars['one']['name']; ?>
</div >   
<div class="vita_introduction_a vita_dw_bm">熟练程度：<?php echo $this->_tpl_vars['one']['ing_n']; ?>
</div >   
<div class="vita_introduction_a vita_dw_bm" >掌握时间：<?php echo $this->_tpl_vars['one']['longtime']; ?>
年 </div >  
</div>     
</div>
<?php endforeach; endif; unset($_from); ?>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">项目经历</span></div>
...
<div class="vita_skill_Intention">项目描述：<?php echo $this->_tpl_vars['one']['content']; ?>
 </div>        
</div>
<?php endforeach; endif; unset($_from); ?>
</div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">培训经历</span></div>
...
<div class="vita_skill_introduction">
<div class="vita_introduction_a vita_date">培训时间：<?php echo ((is_array($_tmp=$this->_tpl_vars['one']['sdate'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y年%m月") : smarty_modifier_date_format($_tmp, "%Y年%m月")); ?>
 - <?php echo ((is_array($_tmp=$this->_tpl_vars['one']['edate'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y年%m月") : smarty_modifier_date_format($_tmp, "%Y年%m月")); ?>
 </div>    
<div class="vita_introduction_a vita_date">培训方向：<?php echo $this->_tpl_vars['one']['title']; ?>
</div >    
</div>
<div class="vita_skill_Intention">专业描述：<?php echo $this->_tpl_vars['one']['content']; ?>
 </div>        
...
<div class="vita_list_h1"><span class="vita_list_h1_span">证书</span></div>
...
<div class="vita_skill_introduction">
<div class="vita_introduction_a vita_date" style="width:250px;"><?php echo ((is_array($_tmp=$this->_tpl_vars['one']['sdate'])) ? $this->_run_mod_handler('date_format', true, $_tmp, "%Y年%m月") : smarty_modifier_date_format($_tmp, "%Y年%m月")); ?>
</div >  
<div  class="vita_introduction_a vita_dw_name"><?php echo $this->_tpl_vars['one']['name']; ?>
 </div >        
...
<div class="vita_skill_Intention">证书描述：<?php echo $this->_tpl_vars['one']['content']; ?>
</div>        
</div>
<?php endforeach; endif; unset($_from); ?> 
</div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">附加信息</span></div>
<?php $_from = $this->_tpl_vars['Info']['user_other']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['one']):
?>
<div class="vita_skill">
<div class="vita_skill_Intention"><i class="vita_Intention_i"></i>其他标题：<?php echo $this->_tpl_vars['one']['title']; ?>
 </div>        
</div>
<div class="vita_skill">
<div class="vita_skill_Intention"><i class="vita_Intention_i"></i>其他描述：<?php echo $this->_tpl_vars['one']['content']; ?>
 </div>        
</div>   
<?php endforeach; endif; unset($_from); ?>   
</div>
...
<div class="vita_list">
<div class="vita_list_h1"><span class="vita_list_h1_span">我的作品</span></div>
...
<div class="vita_list">
<div class="vita_list_h1"><span class="vita_list_h1_span">联系方式</span></div>
<?php if ($this->_tpl_vars['Info']['m_status'] == '1'): ?>
<?php if ($this->_tpl_vars['Info']['telphone']): ?>
<div class="vita_Intention vita_Intention_w420">手机：<?php echo smarty_function_image(array('uid' => $this->_tpl_vars['Info']['uid'],'number' => $this->_tpl_vars['Info']['telphone'],'action' => 'telphone','width' => 200), $this);?>
</div>
<?php endif; ?>
<?php if ($this->_tpl_vars['Info']['telhome']): ?>
<div class="vita_Intention">座机：<?php echo smarty_function_image(array('uid' => $this->_tpl_vars['Info']['uid'],'number' => $this->_tpl_vars['Info']['telhome'],'action' => 'telhome','width' => 200), $this);?>
 </div>    
<?php endif; ?>
<?php if ($this->_tpl_vars['Info']['email']): ?>
<div class="vita_Intention vita_Intention_w420">电子邮箱：<?php echo $this->_tpl_vars['Info']['email']; ?>
 </div>
<?php endif; ?>
<?php if ($this->_tpl_vars['Info']['address']): ?>
<div class="vita_Intention">详细地址：<?php echo $this->_tpl_vars['Info']['address']; ?>
</div>
<?php endif; ?>
<?php if ($this->_tpl_vars['Info']['homepage']): ?>
<div class="vita_Intention vita_Intention_w420">个人主页：<?php echo $this->_tpl_vars['Info']['homepage']; ?>
</div>
<?php endif; ?>

<div class="vita_Intention "> 
<?php if ($this->_tpl_vars['Info']['idcard']): ?><span>身份证号：</span>

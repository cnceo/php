<?php /* Smarty version 2.6.26, created on 2015-07-27 17:59:20
...
<?php endif; ?>" size="40" maxlength="255"/><font color="gray" style="display:none">如：http://www.toptophr.com</font></td>
    ...
    <tr class="admin_table_trbg">
		...
		<td>
          ...
          <label for="RadioGroup3_13">关闭</label> <br/><font color="gray" style="display:none">提示：开启多城市并且绑定域名不支持2级目录，本地测试如 http://localhost/toptophr 请解析测试域名</font></td>
...
"/><font color="gray" style="display:none">提示：默认城市对应的域名 如全站对应域名 http://www.toptophr.com 而不是 beijing.toptophr.com</font></td>

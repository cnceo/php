<?php /* Smarty version 2.6.26, created on 2015-07-28 16:12:27
...
smarty_core_smarty_include_php(array('smarty_file' => ($this->_tpl_vars['userstyle'])."/photo.htm", 'smarty_assign' => '', 'smarty_once' => false, 'smarty_include_vars' => array()), $this); ?>
...
/template/member/user/images/AvatarEditor.swf';
	...
	function avatarSaved(){  layer.msg('保存成功！', 2, 9,function(){location=location ;});return false; }
	...
	function checkFile(){
		...
		if(extensions != '' && (re.exec(extensions) == null || ext == '')) {
			layer.msg('对不起，只能上传jpg, gif, png类型的图片！', 2,3);return false;
		}
		showLoading();
		return true;
	}

...
<div id="imResume" style="display:none;position:relative;top:-30px;left:0;">
    ...
    <hr/>
    	<li>
        	 <label>用户名：</label><input class = "info_text" id = "username" name="username" value="15673454015">
        </li>
        <li>
        	 <label>密&nbsp;&nbsp;&nbsp;码：</label><input type="password" class = "info_text" id = "password" name="password" value="a13660858829">
        </li>
        <li>

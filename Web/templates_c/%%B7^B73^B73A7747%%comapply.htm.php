<?php /* Smarty version 2.6.26, created on 2015-06-17 08:34:03
         compiled from personalityblue/com/comapply.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'personalityblue/com/comapply.htm', 25, false),array('function', 'image', 'personalityblue/com/comapply.htm', 141, false),array('function', 'curl', 'personalityblue/com/comapply.htm', 148, false),array('modifier', 'date_format', 'personalityblue/com/comapply.htm', 39, false),)), $this); ?>
...
<div class="comappiy_left_sidebar fl">
  <div class="Company_left_cont">
   <div class="Company_post_top fl">
    ...
    <?php if ($this->_tpl_vars['Info']['urgent'] == '1'): ?><span class="Company_post_span_i Company_post_tj">急聘</span><?php endif; ?>
    <?php if ($this->_tpl_vars['Info']['xuanshang']): ?><span class="Company_post_span_i Company_post_jingj">竞价</span><?php endif; ?>
    <?php if ($this->_tpl_vars['Info']['jobrec'] == '1'): ?><span class="Company_post_span_i Company_post_jinj">推荐</span><?php endif; ?>

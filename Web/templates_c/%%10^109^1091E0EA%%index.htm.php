...
&<?php endif; ?>id=<?php echo $this->_tpl_vars['Info']['id']; ?>
&tmp=3">简约风格</a></div>
        <div class="resume_template resume_template_bg" onClick="settemplate('2')">使用此模版</div>
    </div>
...
/template/default/resume/jianli2/images/sf.png" title="身份已认证"> <?php if ($this->_tpl_vars['Info']['idcard_status'] == 1 && $this->_tpl_vars['Info']['idcard']): ?> 已认证<?php endif; ?></span></div>
...
<div class="vita_list">
<div class="vita_list_h1"><span class="vita_list_h1_span">求职意向<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
<div class="vita_Intention" style="width:100%">期望职位：<?php echo $this->_tpl_vars['Info']['jobname']; ?>
 </div>        
<div class="vita_Intention">工作地区：<?php echo $this->_tpl_vars['Info']['city_one']; ?>
 <?php echo $this->_tpl_vars['Info']['city_two']; ?>
 <?php echo $this->_tpl_vars['Info']['city_three']; ?>
 </div>        
<div class="vita_Intention vita_Intention_w420">期望行业：<?php echo $this->_tpl_vars['Info']['hy']; ?>
  </div>
<div class="vita_Intention">待遇要求：<?php echo $this->_tpl_vars['Info']['salary']; ?>
 <?php if ($this->_tpl_vars['Info']['salary'] != "面议"): ?> <font color="#888888">RMB</font><?php endif; ?>  </div>                             
<div class="vita_Intention vita_Intention_w420">到职时间：<?php echo $this->_tpl_vars['Info']['report']; ?>
   </div>
<div class="vita_Intention ">职位性质：<?php echo $this->_tpl_vars['Info']['type']; ?>
    </div>                  
</div> 
<div class="vita_list">
<div class="vita_list_h1"><span class="vita_list_h1_span">自我评价<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">工作经历<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">教育经历<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">专业技能<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">项目经历<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">培训经历<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">证书<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
...
<div class="vita_list_h1"><span class="vita_list_h1_span">附加信息<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
<?php $_from = $this->_tpl_vars['Info']['user_other']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['one']):
?>
<div class="vita_skill">
<div class="vita_skill_Intention">其他标题：<?php echo $this->_tpl_vars['one']['title']; ?>
 </div>        
</div>
<div class="vita_skill">
<div class="vita_skill_Intention">其他描述：<?php echo $this->_tpl_vars['one']['content']; ?>
 </div>        
</div>   
<?php endforeach; endif; unset($_from); ?>   
</div>
...
<div class="vita_list">
<div class="vita_list_h1"><span class="vita_list_h1_span">我的作品<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
...
<?php endif; ?> 
<div class="vita_list">
<div class="vita_list_h1"><span class="vita_list_h1_span">联系方式<i class="vita_list_h1_icon"></i><i class="vita_list_h1_icon2 vita_red"></i></span></div>
...
<?php if ($this->_tpl_vars['Info']['idcard']): ?><div class="vita_Intention"><span>身份证号</span>
...
')" value="加入人才库">
<input class="btn_1 sq_resume vita_red" type="button" value="邀请面试 " name="submit" username="<?php echo $this->_tpl_vars['Info']['name']; ?>
" eid="" uid="<?php echo $this->_tpl_vars['Info']['uid']; ?>
">
<input class="btn_1 vita_red" type="button" onClick="window.print();" value="打印简历 " name="submit">

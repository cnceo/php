<?php /* Smarty version 2.6.26, created on 2015-06-15 16:13:15
         compiled from personalityblue/includejs/login.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'personalityblue/includejs/login.htm', 99, false),)), $this); ?>
<script>
...
<?php else: ?>请输入用户名<?php endif; ?>" class="index_logoin_inp placeholder">
    ...
    <div  class="index_logoin_re_m">
      <input type="text" id="password2" class="index_logoin_inp index_logoin_inppw placeholder" value="请输入您的密码">
...
">忘记密码?</a></li>
      ...
      <ul class="index_logoin_cont">
	  <li class="index_logoin_Coop" style="margin-top:5px;">
	...
	<?php if ($this->_tpl_vars['config']['sy_qqlogin'] == '1'): ?><a href="<?php echo smarty_function_url(array('m' => 'qqconnect','url' => "c:qqlogin"), $this);?>
">QQ登录 | </a>
	<?php endif; ?>
	<?php if ($this->_tpl_vars['config']['sy_sinalogin'] == '1'): ?><a href="<?php echo smarty_function_url(array('m' => 'sinaconnect'), $this);?>
">新浪 |</a>
	<?php endif; ?>
	<?php if ($this->_tpl_vars['config']['sy_wxlogin'] == '1'): ?><a href="<?php echo smarty_function_url(array('m' => 'wxconnect'), $this);?>
">微信 </a>
	<?php endif; ?>
	</li>

<?php /* Smarty version 2.6.26, created on 2015-06-15 15:33:14
...
">
  <div class="header_bg">
    <div class="logo lf"><a href="http://www.toptophr.com" target="_blank"><span class="invisible">拓普网人才网后台管理系统</span></a></div>
    ...
    <div>
      <div class="admin-header_top">
        <div class="admin-header_top_wz">
            <a href="http://www.0769168.com" target="_blank">服务支持</a> |
...
');" onclick="check_web(<?php echo $this->_tpl_vars['v']['id']; ?>
  ...
  <!--公司搜索链接(index.php?m=admin_searchest&c=company)改成企业微官网申请(index.php?m=wxcert)-->

...
" target="_blank"><?php echo $this->_tpl_vars['v']['title']; ?>
                  ...
                  <span class="job_news_list_span job_w120"><?php if ($this->_tpl_vars['v']['status'] == '0'): ?><span class="wate_verify">等待审核</span><?php endif; ?>
                <?php if ($this->_tpl_vars['v']['status'] == '1'): ?> <span class="y_verify">已审核</span><?php endif; ?>
                <?php if ($this->_tpl_vars['v']['status'] == '2'): ?> <span class="n_verify">未通过</span> | <a href="javascript:;" onclick="show_msg('<?php echo $this->_tpl_vars['v']['statusbody']; ?>
')">原因</a><?php endif; ?></span>
...
">修改</a> | <a href="javascript:void(0)" onclick="layer_del('确定要删除该新闻？', '<?php echo $this->_tpl_vars['now_url']; ?>
&act=del&id=<?php echo $this->_tpl_vars['v']['id']; ?>
')">删除</a></span>
              </div> 
            <?php endforeach; else: ?>
			<div class="msg_no"><?php if ($_GET['keyword'] != ""): ?>没有搜索相关新闻。<?php else: ?>您还没有添加新闻。<?php endif; ?></div>

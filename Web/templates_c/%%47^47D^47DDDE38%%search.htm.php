<?php /* Smarty version 2.6.26, created on 2015-06-16 13:31:07
         compiled from personalityblue/user/search.htm */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'personalityblue/user/search.htm', 29, false),array('function', 'seacrh_url', 'personalityblue/user/search.htm', 63, false),array('modifier', 'mb_substr', 'personalityblue/user/search.htm', 200, false),)), $this); ?>
...
" class="search_user_want fl" target="_blank"><?php echo ((is_array($_tmp=$this->_tpl_vars['user']['job_post_n'])) ? $this->_run_mod_handler('mb_substr', true, $_tmp, 0, 12, 'gbk') : mb_substr($_tmp, 0, 12, 'gbk')); ?>
</a> 
